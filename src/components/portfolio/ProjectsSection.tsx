const projects = [
  {
    emoji: "🎮",
    name: "Pixel Quest",
    description: "A mini browser game I built from scratch. Click through dungeons, collect coins, don't die. Built with vanilla JS and a lot of patience.",
  ...
  },
  {
    emoji: "🌤️",
    name: "WeatherBoard",
    description: "Shows you the weather with actually useful info — not just a number and a cloud icon. Pulls real data and makes it look nice.",
  ...
  },
  {
    emoji: "🎵",
    name: "Beat Maker",
    description: "A simple drum sequencer that runs in the browser. Tap some pads, make some beats, annoy your parents. It's therapeutic.",
  ...
  },
  {
    emoji: "📝",
    name: "QuickNotes",
    description: "Notes app that actually saves your stuff. No accounts needed, no ads, no nonsense. Just type and it remembers.",
  ...
  },
  {
    ...
    description: "Made this to help my little sister study. She refused to use it. But hey, it works and it's kind of fun.",
  ...
  },
  {
    emoji: "🤖",
    name: "Discord Bot",
    description: "A bot that sends memes on command and tells you random facts. My server uses it ironically but also unironically.",
